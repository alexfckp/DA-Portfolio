# fetch_data.py
"""
Script to download the dataset for House Prices - Advanced Regression Techniques.
...
print("=== Fetching dataset for: House Prices - Advanced Regression Techniques ===")
print("Source: https://www.kaggle.com/c/house-prices-advanced-regression-techniques/data")
